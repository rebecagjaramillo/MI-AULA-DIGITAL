...
export const STATUS_CONFIG = {
  presente:    { label: 'Presente',    color: 'bg-emerald-100 text-emerald-800 border-emerald-200', dot: 'bg-emerald-500', icon: CheckCircle2 },
  falta:       { label: 'Falta',       color: 'bg-rose-100 text-rose-800 border-rose-200',         dot: 'bg-rose-500',    icon: XCircle },
  retardo:     { label: 'Retardo',     color: 'bg-amber-100 text-amber-800 border-amber-200',       dot: 'bg-amber-500',   icon: Clock3 },
  justificado: { label: 'Justificado', color: 'bg-sky-100 text-sky-800 border-sky-200',             dot: 'bg-sky-500',     icon: ShieldCheck },
}

// ============== Actividades ==============
export const ACTIVITY_TYPES = [
  { value: 'tarea',          label: 'Tarea',            color: 'bg-sky-100 text-sky-800' },
  { value: 'trabajo_clase',  label: 'Trabajo en clase', color: 'bg-emerald-100 text-emerald-800' },
  { value: 'proyecto',       label: 'Proyecto',         color: 'bg-violet-100 text-violet-800' },
  { value: 'examen',         label: 'Examen',           color: 'bg-rose-100 text-rose-800' },
  { value: 'participacion',  label: 'Participación',    color: 'bg-amber-100 text-amber-800' },
  { value: 'exposicion',     label: 'Exposición',       color: 'bg-pink-100 text-pink-800' },
  { value: 'practica',       label: 'Práctica',         color: 'bg-teal-100 text-teal-800' },
  { value: 'producto',       label: 'Producto',         color: 'bg-indigo-100 text-indigo-800' },
  { value: 'otro',           label: 'Otro',             color: 'bg-slate-100 text-slate-800' },
]

export const GRADE_STATUSES = [
  { value: 'pendiente',     label: 'Pendiente',    color: 'bg-slate-100 text-slate-700 border-slate-300' },
  { value: 'entregado',     label: 'Entregado',    color: 'bg-emerald-100 text-emerald-800 border-emerald-200' },
  { value: 'tarde',         label: 'Tarde',        color: 'bg-amber-100 text-amber-800 border-amber-200' },
  { value: 'no_entregado',  label: 'No entregó',   color: 'bg-rose-100 text-rose-800 border-rose-200' },
...
export const PLAN_STATUSES = [
  ...
  { value: 'planeada',          label: 'Planeada',   color: 'bg-sky-100 text-sky-800' },
  { value: 'impartida',         label: 'Impartida',  color: 'bg-emerald-100 text-emerald-800' },
  { value: 'requiere_refuerzo', label: 'Reforzar',   color: 'bg-amber-100 text-amber-800' },
  { value: 'evaluada',          label: 'Evaluada',   color: 'bg-violet-100 text-violet-800' },
]

// ============== Biblioteca ==============
export const RESOURCE_TYPES = [
  { value: 'pagina_web',  label: 'Página web',  icon: '🌐', color: 'bg-sky-100 text-sky-800' },
  { value: 'video',       label: 'Video',       icon: '🎬', color: 'bg-rose-100 text-rose-800' },
  { value: 'juego',       label: 'Juego',       icon: '🎮', color: 'bg-violet-100 text-violet-800' },
  { value: 'simulador',   label: 'Simulador',   icon: '🧪', color: 'bg-emerald-100 text-emerald-800' },
  { value: 'documento',   label: 'Documento',   icon: '📄', color: 'bg-amber-100 text-amber-800' },
  { value: 'presentacion',label: 'Presentación',icon: '📊', color: 'bg-pink-100 text-pink-800' },
  { value: 'formulario',  label: 'Formulario',  icon: '📋', color: 'bg-teal-100 text-teal-800' },
  { value: 'plataforma',  label: 'Plataforma',  icon: '🏛️', color: 'bg-indigo-100 text-indigo-800' },
  { value: 'ejercicios',  label: 'Ejercicios',  icon: '✏️', color: 'bg-orange-100 text-orange-800' },
...
export const TOPIC_STATUSES = [
  { value: 'no_iniciado', label: 'No iniciado', color: 'bg-slate-100 text-slate-700 border-slate-300' },
  { value: 'en_curso',    label: 'En curso',    color: 'bg-amber-100 text-amber-800 border-amber-200' },
  { value: 'visto',       label: 'Visto',       color: 'bg-emerald-100 text-emerald-800 border-emerald-200' },
  { value: 'reforzar',    label: 'Reforzar',    color: 'bg-rose-100 text-rose-800 border-rose-200' },
  { value: 'evaluado',    label: 'Evaluado',    color: 'bg-sky-100 text-sky-800 border-sky-200' },
]
