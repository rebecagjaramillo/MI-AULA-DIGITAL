    ...
    <div className="min-h-screen flex flex-col justify-center items-center bg-slate-50 relative overflow-hidden p-4">
      <div className="z-10 w-full max-w-md p-8 bg-white border border-slate-200 rounded-2xl shadow-xl">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-slate-900 mb-2 tracking-tight">Mi Aula Digital</h1>
          <p className="text-slate-500 text-sm">Gestiona tus clases y recursos educativos en una plataforma pensada para ti.</p>
        </div>

        {registered && (
          <div className="mb-6 p-4 rounded-xl bg-emerald-50 border border-emerald-100 text-emerald-700 text-sm text-center font-medium">
        ...
        <form onSubmit={handleCredentialsLogin} className="space-y-4">
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5 ml-0.5">
              ...
              <Link href="/forgot-password" className="text-xs text-sky-600 hover:text-sky-700 transition-colors font-medium">
