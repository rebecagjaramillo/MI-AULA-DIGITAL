...
export const TodosWidget = React.forwardRef(({ id, isDark, editMode, onRemove, className, ...props }, ref) => {
  ...
  return (
    <WidgetContainer ref={ref} id={id} title="Actividades" icon="✅" isDark={isDark} editMode={editMode} onRemove={onRemove} className={className} {...props}>
