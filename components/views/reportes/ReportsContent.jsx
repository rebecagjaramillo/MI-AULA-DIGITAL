...
export default function ReportsPage() {
  ...
  useEffect(() => { 
    ...
    }).catch(e => { toast.error(e.message); setLoadingData(false) }) 
  }, [])
  ...
  return (
    <PageLayout isLoading={loadingData} title="Reportes" subtitle="Genera y exporta reportes profesionales en PDF">
      <Card className="border-slate-100 mb-5">
        <CardContent className="p-5">
          ...
          {/* Filters Row 1: Nivel, Grado, Grupo, (Alumno) */}
          ...
          {/* Filters Row 2: Desde, Hasta, Limpiar */}
