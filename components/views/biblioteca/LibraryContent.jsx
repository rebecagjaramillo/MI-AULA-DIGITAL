              ...
              <Card key={r.id} className="border-slate-100 hover:shadow-md transition-shadow group overflow-hidden">
                <CardContent className="p-5">
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <button onClick={() => toggleFav(r)} className={`text-lg leading-none ${r.favorite ? 'opacity-100' : 'opacity-30 hover:opacity-60'}`} title="Favorito" aria-label="Favorito">⭐</button>
                  </div>
